export default function Message({ message, isOwn, animationDelay = 0 }) {
  return (
    <div
      className={`flex ${isOwn ? "justify-end" : "justify-start"} ${!isOwn ? "animate-fade-in-up" : ""}`}
      style={!isOwn ? { animationDelay: `${animationDelay}ms` } : undefined}
    >
      <div
